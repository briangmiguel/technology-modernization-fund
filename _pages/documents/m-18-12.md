...
---
2022 Update: Please check the following page for the most up-to-date information and submission instructions: [Documents & Templates]({{ site.baseurl }}{% link _pages/documents.md %}).
...
Please complete the form using plain language and submit to OMB, as a .docx file, at [ombtmf@omb.eop.gov](mailto:ombtmf@omb.eop.gov). **Please limit Initial Project Proposals to 2 pages, using 10 point font (“General Information” excepted).**
